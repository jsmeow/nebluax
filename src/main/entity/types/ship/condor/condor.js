...
const enemy = './main/entity/types/ship/condor/assets/images/enemy.png';
const allied = './main/entity/types/ship/condor/assets/images/allied.png';
const damaged = './main/entity/types/ship/condor/assets/images/damaged.png';

function CondorEntity(args) {
...
/** @override **/
CondorEntity.prototype.prowl = function(x, y) {
