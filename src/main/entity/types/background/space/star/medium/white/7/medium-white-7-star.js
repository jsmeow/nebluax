...
const basic =
  './main/entity/types/background/space/star/medium/white/7/assets/images/basic.png';

// A shooting star comet.
function MediumWhite7StarEntity() {
  Entity.call(this);
  ...
  /** @override **/
  this.width = properties.sizes.BACKGROUND.SPACE.STAR.MEDIUM[7].WIDTH;
  this.height = properties.sizes.BACKGROUND.SPACE.STAR.MEDIUM[7].HEIGHT;
...
MediumWhite7StarEntity.prototype = Object.create(Entity.prototype);

module.exports = MediumWhite7StarEntity;
