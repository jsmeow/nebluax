...
const basic =
  './main/entity/types/background/space/star/small/purple/dark/assets/images/basic.png';

// A shooting star comet.
function SmallDarkPurpleStarEntity() {
  Entity.call(this);
  ...
  this.type = [
    ...
    properties.types.BACKGROUND.SPACE.STAR.SMALL.PURPLE.DARK_PURPLE
  ];
...
SmallDarkPurpleStarEntity.prototype = Object.create(Entity.prototype);

module.exports = SmallDarkPurpleStarEntity;
