...
const basic =
  './main/entity/types/background/space/star/medium/white/3/assets/images/basic.png';

// A shooting star comet.
function MediumWhite3StarEntity() {
  Entity.call(this);
  ...
  /** @override **/
  this.width = properties.sizes.BACKGROUND.SPACE.STAR.MEDIUM[3].WIDTH;
  this.height = properties.sizes.BACKGROUND.SPACE.STAR.MEDIUM[3].HEIGHT;
...
MediumWhite3StarEntity.prototype = Object.create(Entity.prototype);

module.exports = MediumWhite3StarEntity;
